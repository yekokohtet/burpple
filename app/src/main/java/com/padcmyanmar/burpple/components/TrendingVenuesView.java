...
public class TrendingVenuesView extends CardView {
    ...
    public TrendingVenuesView(@NonNull Context context) {
        super(context);
    }

    public TrendingVenuesView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TrendingVenuesView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
